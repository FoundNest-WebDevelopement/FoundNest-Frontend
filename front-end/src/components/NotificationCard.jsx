...
export default function NotificationCard({title, date, message, id, onCLick, position, isRead}){
    return(
        <>
                    ...
                    <div className="h-full w-full flex flex-col">
                        <div className="flex justify-between">
                            ...
                            <div className="flex">
                                ...
                                <i className={`fa-solid fa-circle ${isRead? "text-white/0": "text-(--color-quaternary)"} text-xs ml-2`}></i>
                            </div>
                        </div>
