  ...
  return (
    <div className="w-full bg-[#F5F5F5] px-5 py-5 xl:px-15 xl:py-10 min-h-[calc(100vh-5rem)]">
      <div className="flex flex-col xl:flex-row gap-5 h-full min-h-[calc(100vh-10rem)]">
        ...
        {/* ── Left Card ─────────────────────────────────────────────────────── */}
        <div className="w-full xl:w-72 bg-white rounded-xl border border-[#DDD9CF] shadow-[0_4px_4px_0px_rgba(0,0,0,0.1)] p-6 flex flex-col items-center gap-4 flex-1 xl:flex-none">
          ...
          <div className="flex items-center gap-1 text-xs">
            <MapPin size={13} className="text-[#FDC502]" />
        ...
        {/* ── Right Card ────────────────────────────────────────────────────── */}
        <div className="flex-1 bg-white rounded-xl border border-[#DDD9CF] shadow-[0_4px_4px_0px_rgba(0,0,0,0.1)] p-6 flex flex-col gap-6 min-h-full">
          ...
          <div>
            ...
            <div className="rounded-lg overflow-hidden border border-[#DDD9CF] max-w-lg mx-auto">
              {/* Table Header */}
